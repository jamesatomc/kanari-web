                                        ...
                                        {colors.map((color) => (
                                            ...
                                            >
                                                <div 
                                                    ...
                                                    className={`w-full h-20 sm:h-28 ${color.bgClass} cursor-pointer ${color.name === 'White' ? 'border-b dark:border-gray-600' : ''}`}
                                                    title={`Click to copy: ${color.hex}`}
                                                ></div>
                                                <div className="p-3 sm:p-4 bg-white dark:bg-gray-800">
                                                    <h3 className="text-base sm:text-lg font-semibold dark:text-white">{color.name}</h3>
                                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mt-2">
                                                        <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-2 sm:mb-0">{color.hex}</span>
                                                        <button 
                                                            onClick={() => copyToClipboard(color.hex)}
                                                            className="text-xs sm:text-sm text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 flex items-center gap-1 justify-center sm:justify-start"
                                                        >
